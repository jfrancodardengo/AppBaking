...
public class StepDetailFragment extends DialogFragment {
    ...
    public TextView textDetailRecipeName;
    @BindView(R.id.image_detail_step)
    public ImageView imageDetailStep;
    ...
    private Integer idIndexCurrent;
    ...
    public void onPreviousButtonClicked() {
        if (idIndexCurrent == 0) {
            Toast.makeText(getContext(), "Você está no primeiro passo!", Toast.LENGTH_SHORT).show();
        } else {
    ...
    public void onNextButtonClicked() {
        ...
        if (idIndexCurrent == stepSize) {
            Toast.makeText(getContext(), "Você está no último passo!",
